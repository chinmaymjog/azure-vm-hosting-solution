...
- [x] Swapped Azure NetApp Files for Azure Files Premium NFS and
      dropped the preprod/prod split on `main` for a cheaper, faster
      first deploy - full setup stays on `advanced` (2026-09-15)
